...
const collabs = [
  ...
  },
  {
    ...
    alt: "Colaboración entre 666 la buena muerte y evaevaristax"
  },
  {
    ...
    alt: "Colaboración entre rachel19 y kisokobox"
  },
  {
    ...
    alt: "Colaboración entre iwesmendieta y movanastudio."
  }
]
...
<template>
  <section id="colabos" class="scroll-mt-24 px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
    <div class="mx-auto max-w-7xl">
      <div class="max-w-3xl">
        <p class="font-soft text-sm font-semibold uppercase tracking-[0.26em] text-muted">Nuestras colabos</p>
        ...
        <p class="mt-7 max-w-2xl text-lg leading-8 text-muted">
          Reels, TikToks, stories y posts listos para enseñar cómo se vive una marca en la calle, en mesa y en cámara.
        </p>
      </div>
        ...
        >
          <div class="relative overflow-hidden rounded-[1.5rem] bg-soft">
            ...
            <img
              ...
              height="1600"
              loading="lazy"
              class="aspect-[9/16] h-full w-full object-cover transition duration-500 group-hover:scale-[1.03]"
            >

            <div class="pointer-events-none absolute inset-x-0 top-0 z-10 flex items-center justify-between p-4 text-bg">
              <span class="rounded-full bg-text/55 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.18em] backdrop-blur">
                <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="absolute bottom-4 left-4 z-10 rounded-full bg-text/55 px-3 py-2 text-[0.65rem] font-semibold uppercase tracking-[0.16em] text-bg backdrop-blur transition duration-300 hover:bg-text"
              @click.stop
            >
              Ver colabo
            </a>
            ...
            <div v-if="collab.video" class="pointer-events-none absolute inset-0 flex items-center justify-center p-4">
              ...
              <button
                type="button"
                class="pointer-events-auto absolute bottom-4 right-4 grid size-11 place-items-center rounded-full border border-bg/60 bg-transparent text-bg shadow-[0_12px_30px_rgba(17,17,17,0.22)] backdrop-blur-[2px] transition duration-300 hover:border-bg"
                :aria-label="muted[index] ? 'Activar sonido' : 'Silenciar video'"
